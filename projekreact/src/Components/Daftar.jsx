...
import { register } from './api'; // Pastikan Anda sudah membuat file api.js dengan fungsi login dan register
...
const Daftar = () => {
  ...
  const login = () => {
		window.location.href = '/Login1'; // Mengarahkan pengguna ke URL "/menu"
	  };
